...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 pt-16">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-20 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-12 sm:mt-20 px-4">
          <div className="backdrop-blur-xl bg-white/70 dark:bg-gray-900/70 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 transition hover:scale-105">
            <Brain className="h-10 w-10 text-blue-600 dark:text-blue-400 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">
              RAG-Powered
            </h3>
            <p className="text-gray-600 dark:text-gray-300">
              Retrieval Augmented Generation ensures answers are grounded in your actual documents.
            </p>
          </div>
          <div className="backdrop-blur-xl bg-white/70 dark:bg-gray-900/70 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 transition hover:scale-105">
            <Zap className="h-10 w-10 text-blue-600 dark:text-blue-400 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">
              Instant Answers
            </h3>
            <p className="text-gray-600 dark:text-gray-300">
              Get precise answers in seconds, with source citations for verification.
            </p>
          </div>
          <div className="backdrop-blur-xl bg-white/70 dark:bg-gray-900/70 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 transition hover:scale-105">
            <Shield className="h-10 w-10 text-blue-600 dark:text-blue-400 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">
              Secure & Private
            </h3>
            <p className="text-gray-600 dark:text-gray-300">
              Your data never leaves your infrastructure. Local embeddings ensure privacy.
            </p>
          </div>
        </div>
      </div>
